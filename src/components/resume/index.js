      ...
      <div className="progress-wrap">
        ...
        <div class="progress">
          ...
          <div class="progress-container">
            <span class="progress-active" style={{ width: "95%" }}></span>
          </div>
        </div>
      </div>
      <div className="progress-wrap">
        ...
        <div class="progress">
          ...
          <div class="progress-container">
            <span class="progress-active" style={{ width: "90%" }}></span>
          </div>
        </div>
      </div>
      <div className="progress-wrap">
        ...
        <div class="progress">
          ...
          <div class="progress-container">
            <span class="progress-active" style={{ width: "60%" }}></span>
          </div>
        </div>
      </div>
      <div className="progress-wrap">
        ...
        <div class="progress">
          ...
          <div class="progress-container">
            <span class="progress-active" style={{ width: "20%" }}></span>
          </div>
        </div>
      </div>
      <div className="progress-wrap">
        ...
        <div class="progress">
          ...
          <div class="progress-container">
            <span class="progress-active" style={{ width: "30%" }}></span>
          </div>
        </div>
      </div>
      <div className="progress-wrap">
        ...
        <div class="progress">
          ...
          <div class="progress-container">
            <span class="progress-active" style={{ width: "40%" }}></span>
          </div>
        </div>
      </div>
      <div className="progress-wrap">
